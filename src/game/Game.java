...
public class Game {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            switch (response){
                case 1:
                    Login.login(); // Als de gebruiker aangeeft dat hij al een account heeft, wordt de login-methode aangeroepen uit de Login klasse.
                    break outer; //Na succesvol inloggen, verlaat de buitenste while-lus om het spel te starten.
                case 2:
                    SignUp.signUp(); // Als de gebruiker aangeeft dat hij nog geen account heeft, wordt de signUp-methode aangeroepen uit de SignUp klasse.
                    break;
                case 3:
